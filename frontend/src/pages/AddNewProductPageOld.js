...
import FarmersProduceForm from 'src/components/farmerProducefillForm/FarmersProduceForm';
import AddNewProductForm from 'src/components/AddNewProductForm/AddNewProductForm';
...
export default function AddNewProductPageOld() {
