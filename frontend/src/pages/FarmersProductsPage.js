...
import FarmerProduceStatsLong from 'src/components/home/farmer-produce-stats-long';
...
import { FaCircleArrowLeft, FaPlus } from 'react-icons/fa6';
import EditProductForm from 'src/components/EditProductForm/EditProductForm';
...
export default function FarmersProductsPage() {
  ...
  const [selectedSection, setSelectedSection] = useState( /.*/  /*productInFocus*/);
...
useEffect(()=>{
  ...
  dispatch(filterFarmersByCrop(productInFocus.name,allFarmers,filteredFarmers,page,currentLocationFilter,currentCropFilter,currentCropTypeFilter))  
...

{
  ...
  <FaCircleArrowLeft onClick={()=>{navigate(-1)}} style={{color:"#0A6054",fontSize:"1.8rem"}} />
      <div style={{display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"flex-start"}}>

     <div style={{position:"relative",left:"2.6rem"}}> Edit Product Details for: <b>{productInFocus.name}</b> </div>
     
     </div>
      
      <Grid container spacing={2} alignItems="center" justifyContent="flex-start" style={{display:"flex",alignItems:"flex-start",justifyContent:"flex-start",marginTop:"0.3rem",marginBottom:"3rem",paddingRight:"0rem"}}> 
       ...
       
  {
     ...
     <Grid item xs={12} style={{display:"flex",justifyContent:"flex-start",alignItems:"center",marginTop:"1rem" ,gap:"1rem"}}>
      
      <div style={{display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"flex-start"}}>

     <h1 style={{fontWeight:"500",marginBottom:"0rem"}}>Farmers</h1>
     <div> Farmers that produce <b>{productInFocus.name}</b> </div>
      ...
      */}
      ...
      { //
       ...
       farmersFromDB.length > 0 ?
          <FarmerProduceStatsLong  farmers={farmersFromDB}/> 
          :
