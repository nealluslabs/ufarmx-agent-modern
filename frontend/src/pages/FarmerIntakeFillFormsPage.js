...
import FarmerIntakeForm from 'src/components/farmerIntakeForm/FarmerIntakeForm';
...
export default function FarmerIntakeFillFormsPage() {
    ...
    <>
      ...
      */}   
          ...
          <StyledContent>
             ...
             <div style={{maxWidth:"100%",display:"flex",alignItems:"flex-start",justifyContent:"center",marginTop:"-5rem"}}>
