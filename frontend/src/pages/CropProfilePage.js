  ...
  return (
    <>
      ...
      <Container maxWidth="xl">
       ...
       {/**here 2 */}
         <Grid container spacing={2} sx={{ padding: '10px', display: {md: 'flex', xs: 'none'}}}>
...
{/* <Box sx={{display: 'flex', gap: 1}}> */}
     ...
     <Box sx={{ flexGrow: 1}}>
       <Button
         variant="contained"
         style={{ height: '45px', minWidth: '45px', backgroundColor: '#000000',  marginTop: '22.5%', marginLeft: '0.3rem' }}
       >
         <SearchIcon />
       </Button>
     </Box>
