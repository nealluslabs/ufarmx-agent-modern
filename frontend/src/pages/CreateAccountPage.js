...
import { addNewRetailer,requestWelcomeEmail,sendWelcomeEmail } from 'src/redux/actions/group.action';
...
const StyledContainerSecond = styled(Container)(({ theme }) => ({
  ...
  // ✅ Responsive behavior (added only this)
...
const CreateAccountPage = () => {
  ...
  const handleSubmit = (e) => {
   ...
   notifyErrorFxn("Make sure your password passes all checks before submitting!")
      ...
      dispatch(requestWelcomeEmail(formData && formData))
  ...
  return (
    <>
      <Helmet>
        <title>Create Account - UfarmX</title>
      </Helmet>
