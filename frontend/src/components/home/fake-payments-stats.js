...
const columns = !isMobile? [
  ...
  },*/
  {
    ...
    renderCell: (params) => {
      ...
      return <div style={{fontSize:"1rem",display:"flex",alignItems:"center",justifyContent:"flex-start",gap:"1.5rem",width:"60%"}}>
       ...
       <span style={{fontSize:"1rem",display:"flex",alignItems:"center",justifyContent:"flex-start",textAlign:"left"}}>{params.row.date}</span>
 ...
 /* { field: 'cropType', headerName: 'Type', width: 190, renderCell: (params) => {
  ...
  { field: 'method', headerName: 'Method', width: 230, renderCell: (params) => {
    return <div style={{fontSize:"1rem"}}>{params.row.method && params.row.method }</div>;
  }, },
 
  { field: 'amount', headerName: 'Amount', width: 230, renderCell: (params) => {
    return <div style={{fontSize:"1rem"}}>{params.row.amount && params.row.amount }</div>;
  }, },
...
export default function FakePaymentsStats({ crops }) {
