...
const columns =  !isMobile ? [
  ...
  { field: 'approvedDate', headerName: 'Date', width: 180,height:350, renderCell: (params) => {
    return <div style={{fontSize:"0.7rem",display:"flex",flexDirection:"column"}}>
  ...
  }, },
  {
    ...
    renderCell: (params) => {
      ...
      return <div style={{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:"2.5rem",width:280}}>
       ...
       <span style={{display:"flex",alignItems:"flex-start",justifyContent:"flex-start",textAlign:"left",width:"40px",fontSize:"0.7rem",position:"relative",left:"-0rem"}}>{params.row.farmerName}</span>
       <div style={{backgroundColor:"#FFE6BD",borderRadius:"20px",color:"#B36034",padding:"1px",paddingLeft:"12px",paddingRight:"12px",width:"110px",textAlign:"center",border:"1px solid #DEDEDE",position:"relative",left:"2rem",fontSize:"0.7rem"}}>{"My Farmer"}</div>

      </div>;
    },
  },
  { field: 'status', headerName: 'Status', width: 150,height:350, renderCell: (params) => {
    return <div style={{backgroundColor:params.row.status==="Approved"?"#B4DAC5":params.row.status==="Rejected"?"#F9B8C5":"#E4E7EC",borderRadius:"20px",color:params.row.status==="Approved"?"#0B7D3E":params.row.status==="Rejected"?"#D8173D":"black",padding:"1px",paddingLeft:"4px",paddingRight:"4px",width:"90px",textAlign:"center",border:"1px solid #DEDEDE",fontSize:"0.7rem"}}>{params.row.status}</div>;
  }},
  { field: 'total', headerName: 'Total', width: 130,height:350, renderCell: (params) => {
    return <div style={{fontSize:"0.7rem"}}>₦{params.row.totalAmount && params.row.totalAmount}</div>;
  }},
...
[
  {
    ...
    renderCell: (params) => {
      ...
      //const fullName = `${params.row.fName} ${params.row.lName}`;
      return <div style={{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:"2.5rem",width:350}}>
...
export default function FakeFormsStatsLong2({ forms }) {
          ...
          if (col.field === 'actions') {
            return {
              ...
              renderCell: (params) => (
               ...
               style={{cursor:"pointer",color:"#0A6054",fontSize:"0.7rem"}}>
               View
            ...
            return {
              ...
              renderCell: (params) => (
                ...
                <span style={{display:"flex",alignItems:"center",justifyContent:"flex-start",textAlign:"left",width:"40px",fontSize:"0.7rem"}}>{params.row.title}</span>
