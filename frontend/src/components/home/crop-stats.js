...
const columns = !isMobile? [
 ...
 /* { field: 'cropType', headerName: 'Type', width: 190, renderCell: (params) => {
  ...
  { field: 'lastHarvest', headerName: 'Harvest Quantity',  width: 180, renderCell: (params) => {
    return <div style={{fontSize:"1rem"}}>{params.row.lastHarvest}</div>;
  }, },
  { field: 'harvestDate', headerName: 'Harvest Date', width: 180, renderCell: (params) => {
