...
//
 ...
 useEffect(()=>{
  setProductName(productInFocus.name)
...
/**DONT DELETE THE USE EFFECT ABOVE YOU NEED IT FOR FIRST ENTRY ONTO THIS PAGE */
   ...
   {
    _id:productInFocus && productInFocus._id,
   name:productName,
            ...
            <>
              <Grid item sm={fields && fields.length < 2 ? 12 : 5} xs={12}> 
                <Stack spacing={3} sx={{
                  ...
                  {
                    <Grid xs={12} item sx={{ marginBottom: "0rem", marginRight: { xs: "0rem", sm: "1rem" }, marginBottom: "0.8rem" }} onBlur={() => setTimeout(() => { setIsDropdownOpen(false) }, 200)}>
                      {/* <Box sx={{ position: "relative", minWidth: { xs: "100%", sm: "27.2rem" }, width: "100%" }}> */}
                        <TextField
                          fullWidth
                          key={"product Name"}
                          label={"Product Name"}
                    ...
                    <>
                      ...
                      <Box sx={{ 
                        ...
                        <input 
                          ...
                          onChange={handleTeacherPassportFile} 
                        />
                      </Box>
                    </>
                  }
