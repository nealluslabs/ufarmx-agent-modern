        ...
        { 
          <>
            <Grid container spacing={2} sx={{ 
              ...
              <Grid item xs={12} md={5}> 
                <Stack spacing={3}>
                  <TextField 
                    ...
                    InputProps={{ style: { height: "3rem", paddingLeft: "1rem" } }}
                  />

                  <FormControl sx={{ minWidth: { xs: "100%", md: 140 }, background: 'white' }}>
                    <Select
                      value={gender}
              ...
              <Grid item xs={12} md={5} sx={{ marginTop: { xs: "0rem", md: "-1.5rem" } }}> 
                <Stack spacing={3}>
                  <TextField 
                    name="lname" 
                    required 
