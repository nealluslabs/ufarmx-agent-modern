...
//const [selectedAgent, setSelectedAgent] = useState(responseInFocus.agent_user_id && responseInFocus.agent_user_id);
  //console.log("RESPONSE IN FOCUS RIGHT B4 WE BLEW UP EVERYTHING---->",responseInFocus)
      ...
      <form onSubmit={userSignup}>
        ...
        <>
          <Grid container spacing={2} sx={{ 
            ...
            <>
              ...
              <Grid item xs={12} md={5}> 
                <Stack spacing={3} sx={{
                  ...
                  {Object.keys(responseInFocus.responseObject)
                    .filter(
                      (key) =>
                        ![
                          'farmer_id',
                    ...
                    ).slice(0,Math.floor(Object.keys(responseInFocus.responseObject).filter(
                      (key) =>
                        ![
                          'farmer_id',
                          '_id',
                    ...
                    <TextField sx={{ minWidth: "100%", color: "black", width: "100%" }}
                  ...
                  {   /**JOSHUA DO NOT MAKE CHANGES */
                    <Grid xs={12} item sx={{ marginBottom: "0rem", marginRight: { xs: "0rem", md: "1rem" }, width: "100%" }}>
                      <FormControl sx={{ minWidth: { xs: "100%", md: 440 }, width: "100%", background: 'white' }}>
                        <Select
              ...
              <Grid item xs={12} md={5}> 
                <Stack spacing={3} sx={{ width: "100%" }}>
                  {Object.keys(responseInFocus.responseObject)
                    ...
                    .slice(Math.floor(Object.keys(responseInFocus.responseObject).filter(
                      (key) =>
                        ![
                          'farmer_id',
                          '_id',
                    ...
                    ).length/2), Object.keys(responseInFocus.responseObject).filter(
                      (key) =>
                        ![
                          'farmer_id',
                          '_id',
            ...
            responseInFocus && responseInFocus ?
              ...
              <Grid item xs={12} md={5}> 
                <Stack spacing={3} sx={{
                  ...
                  {Object.keys(responseInFocus)
                    ...
                    .slice(0,Math.floor(Object.keys(responseInFocus).filter(
                      (key) =>
                        ![
                          'farmer_id',
                          '_id',
                    ...
                    <TextField sx={{ minWidth: "100%", color: "black", width: "100%" }}
                      InputLabelProps={{ shrink: true }} 
                      InputProps={{ style: { height: "3rem", paddingLeft: "1rem", color: "black" }}}
                      onChange={(e) => { /*dispatch(saveResponseInFocus({...responseInFocus,responseObject:{...responseInFocus,[key]:e.target.value  }} ))*/
                        key !== "_id" && dispatch(saveResponseInFocus({ ...responseInFocus, [key]: e.target.value }))
                      }}
                      key={key}
                      disabled={key === "_id"}
                      label={key}
                      value={responseInFocus[key]}
                      variant="outlined"
                    />
                  ))}
              ...
              <Grid item xs={12} md={5}> 
                <Stack spacing={3} sx={{ width: "100%" }}>
                  {Object.keys(responseInFocus)
                    ...
                    .slice(Math.floor(Object.keys(responseInFocus).filter(
                      (key) =>
                        ![
                          'farmer_id',
                          '_id',
                    ...
                    ).length/2), Object.keys(responseInFocus).length).map((key) => (
                    <TextField 
                      sx={{ color: "black", width: "100%" }}
                      InputLabelProps={{ shrink: true }} 
                      InputProps={{ style: { height: "3rem", paddingLeft: "1rem", color: "black" }}}
                      onChange={(e) => { /*console.log("CHANGING NOW!--->",`${responseInFocus.responseObject[key]}`)*/; dispatch(saveResponseInFocus({ ...responseInFocus, [key]: e.target.value })) }}
                      key={key}
                      label={key}
                      value={responseInFocus/*.responseObject*/[key]}
                      variant="outlined"
        ...
        { 
          <>
            ...
            */}
            ...
            <center sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, gap: 2, alignItems: "center", width: "100%" }}>
              <LoadingButton 
                onClick={() => { navigate(-1) }}
                size="large" 
                type="button" 
              ...
              <LoadingButton 
                onClick={() => { dispatch(updateResponse(responseInFocus)) }}
                size="large" 
                type="button" 
                variant="contained" 
                disabled={loading} 
