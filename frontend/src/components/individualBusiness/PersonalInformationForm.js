...
import {uploadPhotoIdInd} from 'src/redux/actions/group.action'
...
const PersonalInformationForm = ({ personalData, onInputChange, onBack, onContinue }) => {
  ...
  const [photoIdIndFile, setPhotoIdIndFile] = useState(null);
const [photoIdIndPhotoURL, setPhotoIdIndPhotoURL] = useState('')


const handlePhotoIdIndChange = (e) => {
const file = e.target.files[0];
if (file) {
setPhotoIdIndFile(file);
setPhotoIdIndPhotoURL(file.name);
dispatch(uploadPhotoIdInd(file))
}
}
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <UploadBox>
                    ...
                    type="file"
                    multiple
                    onChange={handlePhotoIdIndChange}
