...
// @mui
import { Link, Stack, IconButton, InputAdornment, TextField, Checkbox, Grid, Button, Avatar, FormControl, MenuItem, Select, Typography, Divider, CardMedia, FormControlLabel, RadioGroup, Radio, Chip, Paper, Box, FormGroup } from '@mui/material';
...
export default function InTakeFormCopy() {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const classes = useStyles();

  const [forms, setForms] = useState([
    { cropName: '', harvestStart: '', harvestEnd: '', quantity: '' }
  ]);
  ...
  const addNewForm = (e) => {
    e.preventDefault();
    setForms([...forms, { cropName: '', harvestStart: '', harvestEnd: '', quantity: '' }]);
  };
...
const [step3, setStep3] = useState(false);
 ...
 const [interestInIncreasingProduction, setInterestInIncreasingProduction] = useState('');
...
const getGeolocation = () =>{
  ...
  const finalObject = 
    
   {
    ...
    responseObject:{
     ...
     maritalStatus,
     familySize,
     interestInIncreasingProduction,
     harvestSize,
     hasID,
     idType:idTpye,
     hasSmartphone,
  ...
  const storeRandomNumber = () => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault();
      console.log('Crop Data Submitted:', forms);
      storeRandomNumber();
    };
...
<>
     ...
     <Grid container xs={12} spacing={2} sx={{width:{md:"1000px", xs: '100%'},display:"flex", alignItems:"center",justifyContent:"center",gap:"4rem"}}>  
    
    
    
      <>
     <Grid item xs={12}style={{width:"90%",display:"flex",flexDirection:"column",alignItems:"flex-start", left:{xs: '-2rem', md: '0rem'}, justifyContent:"center"}}>
     ...
     <Grid item sm={fields && fields.length < 2 ?12:5 }  xs={12}   > 
       ...
       <TextField
        ...
        <TextField
          ...
          InputProps={{
            style: { height: '3rem', paddingLeft: '1rem', color: 'gray',backgroundColor:"#F9FAFB",height:"4rem",paddingRight:"1rem", },
          }}
...
{<Select  
          sx={{backgroundColor:"#FFFFFF",borderRadius:"0.1rem",width:"100%", height: '3rem', paddingLeft: '1rem',maxWidth:{xs:"20rem",sm:"70%",md:"80%",lg:"100%"} , color: 'black',backgroundColor:"#F9FAFB",height:"4rem"}}
         inputProps={{
          style: { height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem" },
...
{<Select
          sx={{backgroundColor:"#FFFFFF",borderRadius:"0.1rem",width:"100%", height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem",maxWidth:{xs:"20rem",sm:"70%",md:"80%",lg:"100%"} }}
         inputProps={{
          style: { height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem" },
 ...
 {<Select
         ...
         inputProps={{
          ...
          renderValue={(selected) => {
            if (selected.length === 0) {
              return <em style={{color:"lightgray"}}>Family Size</em>;
            }
...
<Grid item xs={12}style={{maxWidth:{md:"1000px"},width:"90%",display:"flex",flexDirection:"column",alignItems:"flex-start", justifyContent:"center",marginBottom:"2.5rem",marginLeft:"2.5rem"}}>
          <Typography color="textPrimary" variant="p" component="p" style={{ color: '#000000',position:"relative" }}>
            Farm Information
          </Typography>
 ...
 <Grid container xs={10} style={{display:"flex",justifyContent:"flex-start",alignItems:"center",gap:"2rem"}} >
  ...
  <Select
          sx={{backgroundColor:"#FFFFFF",borderRadius:"0.1rem",width:"100%",marginLeft:{xs:"50%",sm:"0%"}, maxWidth:{xs:"20rem",sm:"70%",md:"80%",lg:"100%"},height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem"}}
         inputProps={{
          style: { height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem" },
  ...
  <Select
          sx={{backgroundColor:"#FFFFFF",borderRadius:"0.1rem",width:"100%", height: '3rem',maxWidth:{xs:"25rem",sm:"70%",md:"80%",lg:"100%"}, paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem"}}
         inputProps={{
          style: { height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem" },
 ...
 <Select
          sx={{backgroundColor:"#FFFFFF",borderRadius:"0.1rem",width:"100%",maxWidth:{xs:"28em",sm:"70%",md:"80%",lg:"100%"}, height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem"}}
         inputProps={{
          style: { height: '3rem', paddingLeft: '1rem', color: 'black',backgroundColor:"#F9FAFB",height:"4rem" },
  ...
  <MenuItem   value={"NPK-15-15-30"}>NPK-15-15-30</MenuItem>
        ...
        <TextField
          key={"promptKey"}
          label={'Are you interested in increasing your production?'}
          value={interestInIncreasingProduction}
          onChange={(e)=>{setInterestInIncreasingProduction(e.target.value)}}
...
>
  <FormGroup style={{ color: "grey", flexDirection: "column" }}>
    <FormControlLabel
      control={
        <Checkbox
          onChange={(event) => setEducationLevel((prev) => ({ ...prev, basicLiteracy: event.target.checked }))}
          style={{ color: "grey" }}
        />
      }
      label={
    ...
    <FormControlLabel
      control={
        <Checkbox
          onChange={(event) => setEducationLevel((prev) => ({ ...prev, agriculturalTraining: event.target.checked }))}
          style={{ color: "grey" }}
        />
      }
      label={
...
<Grid item  sm={5} xs={12} style={{display:"flex",justifyContent:"center",alignItems:"center"}} > 
 <Stack spacing={3} sx={{paddingLeft:{xs:"3rem",sm:"0rem"}}} >
  ...
  <div style={{display:"inline-flex"}}>Education / Training:&nbsp;{' '}{' '} <span style={{fontWeight:"bold"}}>{educationLevel}</span></div>
...
//  <Stack sx={{display:"flex",justifyContent:"center",alignItems:"center", flexDirection:{xs:"column",sm:"row"},gap:"1rem"}}></Stack>
...
//  size="large" type="button" variant="contained" disabled={loading} sx={{ width:"100%",maxWidth:{xs:"20rem",sm:"29rem"},fontWeight:"500",color: 'white',backgroundColor: '#0A6054'}} />
