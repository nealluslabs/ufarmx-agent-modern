...
export default function FarmersCreditAnalysisForm() {
  ...
  //("Form IN FOCUS WHILE FILLING------->",formInFocus)
...
:
      ...
      <Grid item xs={12} sm={5}> 
       <Stack spacing={3}  sx={{position:"relative",top:"0.2rem",minHeight:"100%",paddingTop:"0rem", display:"flex", alignItems:"flex-start",justifyContent:"flex-start",gap:"0.05rem",marginLeft:{xs:"27.5rem",sm:"0rem"}}}  >
...
{
  <Grid xs={2} item style={{marginRight:"1rem",marginBottom:"0rem"}}>
     <Box sx={{ position: "relative", minWidth: "27.2rem" }}>
     <TextField
        fullWidth
        variant="outlined"
        value={farmerInFocus && farmerInFocus.phone?farmerInFocus.phone:farmerInFocus && farmerInFocus.phone_number?farmerInFocus.phone_number:farmerInFocus && farmerInFocus.phoneNumber && farmerInFocus.phoneNumber}
