...
export default function FarmersInputForm() {
...
<>
     ...
     <Grid container spacing={2} style={{width:"100%", maxWidth:"1100px", display:"flex", alignItems:"center",justifyContent:"center",gap:"1rem", margin:"0 auto"}}>  
   ...
   <>
     ...
     <Grid item xs={12} md={fields && fields.length < 2 ? 12 : 5}> 
       <Stack spacing={3} sx={{
         minHeight:"100%",
         paddingTop:"0rem", 
         display:"flex", 
...
{
  <Grid xs={12} item style={{marginBottom: "0rem", marginRight:{xs:"0rem", sm:"1rem"}, marginBottom:"0rem", width:"100%"}}>
