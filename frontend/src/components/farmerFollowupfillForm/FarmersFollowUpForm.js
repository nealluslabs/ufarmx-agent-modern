...
import { addNewDeposit, filterFarmersByName, submitNewResponse, updateFormFields } from 'src/redux/actions/group.action';
...
export default function FarmersFollowUpForm() {
...
*/
 ...
 const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  ...
  const submitResponse = (updatedFields) =>{
   ...
   dispatch(submitNewResponse(updatedFields))
...
{
  <Grid xs={12} item sx={{marginBottom: "0rem", marginRight: {xs: "0rem", sm: "1rem"}, marginBottom: "0.8rem", width: "100%"}}>
...
promptKey === "What do you cultivate?"?
<TextField
          key={promptKey}
          label={promptKey}
          value={farmerInFocus && farmerInFocus.crops?farmerInFocus.crops:farmerInFocus && farmerInFocus.produce?farmerInFocus.produce:farmerInFocus && farmerInFocus.farming_crop?farmerInFocus.farming_crop:farmerInFocus && farmerInFocus.crop_types?farmerInFocus.crop_types:farmerInFocus && farmerInFocus.what_crop_are_you_farming?farmerInFocus.what_crop_are_you_farming:formValues1[promptKey]}
          onChange={handleChange1(promptKey)}
          sx={{ color: 'black', width: "100%" }}
          InputLabelProps={{ shrink: true }}
          InputProps={{
...
promptKey === "What are your difficulties"?
<TextField
          key={promptKey}
          label={promptKey}
          value={farmerInFocus && farmerInFocus.challenges?farmerInFocus.challenges:formValues1[promptKey]}
          onChange={handleChange1(promptKey)}
          sx={{ color: 'black', width: "100%" }}
          InputLabelProps={{ shrink: true }}
          InputProps={{
...
<>
  ...
  */}
      ...
      {<LoadingButton 
        ...
        onClick={()=>{ submitResponse(formInFocus._id && finalObject) }}
        size="large" type="button" variant="contained" disabled={loading} sx={{
